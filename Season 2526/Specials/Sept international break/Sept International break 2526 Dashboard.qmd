---
title: "Chelsea Season Review 2526"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2526/Specials/")
...
#Set LFC
Match_Home <- paste("Chelsea")

#set Home color
Color_Home <- paste("dodgerblue3")
...
#set Game name
GameName <- paste("EPL2526_Chelsea_Sep_International_Break")
...
plottingData <- plottingData %>%
  ...
  mutate(Game_Block = case_when(
    Game_date >= as.Date("2025-08-01", format = "%Y-%m-%d") & Game_date <= as.Date("2025-08-31", format = "%Y-%m-%d") ~ 1,
    Game_date >= as.Date("2025-09-01", format = "%Y-%m-%d") & Game_date <= as.Date("2025-09-31", format = "%Y-%m-%d") ~ 2,
