---
title: "Nov International Break 2526"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2526/Specials/Nov International break")
...
MatchSummarySeasonPlayerTableHome <- MatchSummarySeasonPlayerData %>%
  filter(Team == Match_Home) %>%
  gt(groupname_col = "Team", rowname_col = "Name") %>%
...
HometouchPlot1Sub <- TouchTeamPlot_OPTA(TouchDataLFC,  title = paste0(Match_Home, " Team On Ball Touch"),
...
HometouchPlot1Sub <- TouchTeamPlot_OPTA(TouchDataLFCB1,  title = paste0(Match_Home, " Team On Ball Touch"),
                                     plot_start = 00, plot_finish = firstSubHome, color = Color_Home, logo = "", method = "mad",
                                     subtitle = paste0(Match_Fixture, " Up to 1st Sub"))
HometouchPlot1Sub
```
...
HometouchPlot1Sub <- TouchTeamPlot_OPTA(TouchDataLFCB2,  title = paste0(Match_Home, " Team On Ball Touch"),
                                     plot_start = 00, plot_finish = firstSubHome, color = Color_Home, logo = "", method = "mad",
                                     subtitle = paste0(Match_Fixture, " Up to 1st Sub"))
HometouchPlot1Sub
```
...
HometouchPlot1Sub <- TouchTeamPlot_OPTA(TouchDataLFCB3,  title = paste0(Match_Home, " Team On Ball Touch"),
                                     plot_start = 00, plot_finish = firstSubHome, color = Color_Home, logo = "", method = "mad",
                                     subtitle = paste0(Match_Fixture, " Up to 1st Sub"))
HometouchPlot1Sub
```
