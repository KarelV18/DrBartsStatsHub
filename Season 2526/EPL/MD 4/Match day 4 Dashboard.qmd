...
#Set Home
Match_Home <- paste0("Burnley")

#set match date
Game_date <- paste("14-09-2025")
...
fileName <- paste0("~/Dropbox/AI LFC data/Data Sets/WhoScored/Season 2526/EPL Games/Processed Games/", Match_Fixture, ".xlsx")
...
```{r}
#| output: false
#| label: load in player data frames and set values
#| message: false
#| warning: false

PlayerfileName <- paste0("~/Dropbox/AI lfc data/Data Sets/WhoScored/Season 2526/EPL Players/Processed Games/", Match_Fixture, "- PlayerData.xlsx")
